							...
							<div class="header-column">
								<div class="header-row">
									<div class="header-logo">
										<a href="index.html">
											<img alt="Kumsal Photo" width="82" height="40" src="img/kumsal-logo.png">
										</a>
									</div>
								</div>
							</div>
							<div class="header-column justify-content-end">
								<div class="header-row">
													...
													<li class="dropdown">
														...
														<ul class="dropdown-menu">
																<li class="dropdown-submenu">
																	<a class="dropdown-item" href="#">Çekim</a>
																				<ul class="dropdown-menu">
																<li>
																	<a class="dropdown-item" href="#">Hamile Çekim</a>
																	
																</li>
																<li>
																	<a class="dropdown-item" href="#">Doğum Çekim</a>
																</li>
																<li>
																	<a class="dropdown-item" href="#">Evime Hoşgeldin Çekimi</a>
																</li>
																<li>
																	<a class="dropdown-item" href="#">Yenidoğan Çekimi</a>
																</li>
																<li>
																	<a class="dropdown-item" href="#">Ara Dönem Çekimi</a>
																</li>
																<li>
																	<a class="dropdown-item" href="#">1 Yaş Çekimi</a>
																</li>
																<li>
																	<a class="dropdown-item" href="#">2 Yaş Çekimi</a>
																</li>
																<li>
																	<a class="dropdown-item" href="#">3 Yaş Çekimi</a>
																</li>
																<li>
																	<a class="dropdown-item" href="#">Özel Gün Çekimleri</a>
																</li>
																<li>
																	<a class="dropdown-item" href="#">Yeni Yıl Çekimleri</a>
																</li> 
																<li>
																	<a class="dropdown-item" href="#">Dış Çekimler</a>
																</li> 
															</ul>
															</li>
																<li class="dropdown-submenu">
																				<a class="dropdown-item" href="#">Albüm</a>
																							<ul class="dropdown-menu">
																			<li>
																				<a class="dropdown-item" href="#">20x40 Tek Albüm</a>
																				
																			</li>
																			<li>
																				<a class="dropdown-item" href="#">25x50 Tek Albüm</a>
																			</li>
																			<li>
																				<a class="dropdown-item" href="#">Küçük albümler(anneanne ve babaanne)</a>
																			</li>
																			<li>
															...
															<li class="dropdown-submenu">
																				<a class="dropdown-item" href="#">Eğitim</a>
																							<ul class="dropdown-menu">
																			<li>
																				<a class="dropdown-item" href="#">Temel Fotoğrafçılık</a>
																				
																			</li>
																			<li>
																				<a class="dropdown-item" href="#">Yenidoğan Fotoğrafçılığı</a>
									...
									<div class="header-nav-features header-nav-features-light header-nav-features-no-border header-nav-features-lg-show-border order-1 order-lg-2">
											...
											<a href="https://www.instagram.com/kumsal.photography/" lass="header-nav-features-toggle" target="_blank"> 
    <i class="icon-social-instagram icons icons header-nav-top-icon-img"></i>
												
												
											</a>
											
    
										</div><div class="header-nav-feature header-nav-features-cart d-inline-flex ml-2">
											<a href="#" class="header-nav-features-toggle">
    <i class="icon-social-facebook icons icons header-nav-top-icon-img"></i>
											...
											<a href="#" class="header-nav-features-toggle">
    <i class="icon-social-twitter icons header-nav-top-icon-img"></i>
					...
					<div id="revolutionSlider" class="slider rev_slider" data-version="5.4.8" data-plugin-revolution-slider data-plugin-options="{'sliderLayout': 'fullscreen', 'delay': 9000, 'gridwidth': 1170, 'gridheight': 700, 'disableProgressBar': 'on', 'responsiveLevels': [4096,1200,992,500], 'parallax': { 'type': 'scroll', 'origo': 'enterpoint', 'speed': 1000, 'levels': [2,3,4,5,6,7,8,9,12,50], 'disable_onmobile': 'on' }, 'navigation' : {'arrows': { 'enable': true, 'style': 'arrows-style-1 arrows-primary' }, 'bullets': {'enable': true, 'style': 'bullets-style-1', 'h_align': 'center', 'v_align': 'bottom', 'space': 7, 'v_offset': 70, 'h_offset': 0}}}">
						<ul>
							<li class="slide-overlay slide-overlay-level-8" data-transition="fade">
								<img src="img/slides/slide-corporate-10-1.jpg"  
									alt=""
								...
								<div class="tp-caption text-color-light font-weight-normal"
									...
									data-transform_in="y:[-50%];opacity:0;s:500;">DERYA KAYA ATEŞAL</div>
								...
								<div class="tp-caption font-weight-extra-bold text-color-light"
									...
									data-lineheight="['150','150','150','260']">K</div>
								...
								<div class="tp-caption font-weight-extra-bold text-color-light"
									data-frames='[{"delay":2200,"speed":1000,"frame":"0","from":"opacity:0;x:-50%;","to":"opacity:0.7;x:0;","ease":"Power3.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"opacity:0;fb:0;","ease":"Power3.easeInOut"}]'
									data-x="center" data-hoffset="['210','210','210','365']"
									data-y="center"
									data-fontsize="['145','145','145','250']"
								...
								<div class="tp-caption font-weight-light text-color-light"
									...
									data-lineheight="['26','26','26','45']">Photography</div>
							...
							<li data-transition="fade" class="slide-overlay slide-overlay-level-8">
								<img src="img/slides/slide-corporate-10-2.jpg"  
									alt=""
									data-bgposition="center center" 
									data-bgfit="cover" 
									data-bgrepeat="no-repeat" 
								...
								<div class="owl-carousel owl-theme nav-style-1 stage-margin mb-0" data-plugin-options="{'responsive': {'576': {'items': 1}, '768': {'items': 2}, '992': {'items': 3}, '1200': {'items': 4}}, 'margin': 3, 'loop': true, 'nav': true, 'dots': false, 'stagePadding': 40}">
									...
									<div class="m-3">
										<div class="hover-effect-3d">
											<div class="thumb-info thumb-info-hide-wrapper-bg thumb-info-no-zoom rounded-0">
												<div class="thumb-info-wrapper">
													<img src="img/gallery/gallery-5.jpg" class="img-fluid rounded-0 hover-effect-2" alt="">
												</div>
											</div>
										</div>
									</div>
			...
			<footer id="footer" class="bg-color-light border-0 pt-5 mt-0">
				...
				<div class="footer-copyright curved-border curved-border-top d-flex align-items-center">
					<div class="container py-2">
						<div class="row py-4">
							<div class="col text-center">
								<p class="text-3">2020 © <strong class="font-weight-normal text-color-light opacity-7">Kumsal Photograpy</strong> - Copyright. All Rights Reserved.</p>
							</div>
						</div>
					</div>
				</div>
